...
public:
	...
	virtual	GS::Optional<NonLocalizedPropertyName>			GetNonLocalizedName					() const = 0;
	...
	virtual GS::AutoPtr<GS::DynamicValue>						ResolvePropertyValue				(const GS::DynamicValue* originalValue) const = 0;
	...
	virtual	PropertyValue									GetValue							(const PropertyOwner& propertyOwner, const GS::DynamicValueConversionRules& conversionRules) const = 0;
	virtual	bool											ValueIsEditable						(const PropertyOwner& propertyOwner) const = 0;
	virtual	void											SetValue							(const PropertyOwner& propertyOwner, const GS::DynamicValue* newValue) const = 0;
