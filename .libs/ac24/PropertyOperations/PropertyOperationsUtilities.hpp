...
void			ConvertAttributeIndexMeasureToDisplayValue (const ADB::AttributeSetConstRef& attributeSet, Property::Measure::MeasureType measureType, const GS::DynamicValue* value, GS::AutoPtr<GS::DynamicValue>& displayValue);
