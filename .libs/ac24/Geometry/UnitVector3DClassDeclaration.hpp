...
public:
	...
	bool IsParallelWith		(const CustomUnitVector3D& other, const AngleTolerance& tol = AngleTolerance { RadEps }) const;
	bool IsEqualWith		(const CustomUnitVector3D& other, const AngleTolerance& tol = AngleTolerance { RadEps }) const;
	bool IsPerpendicularTo	(const CustomUnitVector3D& other, const AngleTolerance& tol = AngleTolerance { RadEps }) const;

	static bool AreParallel			(const CustomUnitVector3D& u1, const CustomUnitVector3D& u2, const AngleTolerance& tol = AngleTolerance { RadEps });
	static bool AreEqual			(const CustomUnitVector3D& u1, const CustomUnitVector3D& u2, const AngleTolerance& tol = AngleTolerance { RadEps });
	static bool ArePerpendicular	(const CustomUnitVector3D& u1, const CustomUnitVector3D& u2, const AngleTolerance& tol = AngleTolerance { RadEps });
