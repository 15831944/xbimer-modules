...
namespace CAT {
class CategorySet;
typedef ODB::ConstRef<CategorySet> CategorySetConstRef;
}

namespace Phasing {
class PhasingModelVariationCriteria;
}
...
public:
	...
	OpeningPhasingLogic (
		...
		const Phasing::PhasingModelVariationCriteria*	phasingModelVariationCriteria	= nullptr);
