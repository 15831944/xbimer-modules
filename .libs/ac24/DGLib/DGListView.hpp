...
private:
	...
	virtual bool	NotifyItemMouseDownEvent (const ItemMouseDownEventArg& eventArg) override;
	virtual bool	NotifySelectionChangeRequestEvent (const ItemMouseDownEventArg& eventArg) override;
...
public:
	...
	EventNotifier<ListView, const ItemMouseDownEventArg, bool, false> onMouseDown;
	EventNotifier<ListView, const ItemMouseDownEventArg, bool, false> onSelectionChangeRequested;
