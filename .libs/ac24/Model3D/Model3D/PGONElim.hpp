...
MODEL3D_DLL_EXPORT
GSErrCode	MODEL3D_CALL	PGONElim (GS::ProcessControl& processControl, const Modeler::Model3DViewer& viewer, Modeler::ElimDataArray& data, const GS::HashTable<UIndex, bool> *elimElems, bool skipTransparents = true);
