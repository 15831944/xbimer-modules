...
enum BeamDrawingMethodTypes {	// Controls the way beams are displayed
	BeamFullDrawing,				// Both the contour and reference line is displayed
	BeamRefLineDrawing,				// Only the reference line is displayed
	BeamContourDrawing				// Only the contour is displayed
};
