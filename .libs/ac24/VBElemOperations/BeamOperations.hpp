...
public:
	...
	static GS::Optional<double>		GetBeamRadius (const VBElem::BeamConstRef& beam);
	...
	static Box3D GetRawBounds3D (const VBElem::BeamConstRef& beam);
	static Box3D GetRawBounds3D (const VBElem::BeamSegmentConstRef& beam);
