...
public:
	...
	static bool Overlaps (const VBElem::OpeningRef& opening, const VBElem::ModelElementRef& modelElem);
	static void RelinkAndReconnect (const VBElem::OpeningRef& opening, bool reconnectIsAllowed, const GS::Array<VBElem::ModelElementRef>& modelElems);
