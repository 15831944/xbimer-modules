...
private:
	...
	Statistics						stats;
	mutable std::shared_timed_mutex	contextsMutex;
...
public:
	...
	void* HACK_CreateOpenGLContext (void* view) override;
	void HACK_UpdateOpenGLContext (void* view) override;
	void HACK_DeleteOpenGLContext (void* view) override;
	void HACK_RefreshDrawable ();
	void HACK_RefreshOpenGLContext (int universe);
