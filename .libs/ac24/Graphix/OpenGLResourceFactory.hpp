...
typedef std::unordered_map<std::string, SamplerBinding> InputSamplerBindings;
...
private:
	...
	InputSamplerBindings	samplerBindings;
...
public:
	OpenGLShaderProgram (OpenGLStateManager* manager, const InputBufferBindings& bufferbindings, const InputSamplerBindings& samplerbindings, const PushConstantBlocks& pushconstantblocks);
	~OpenGLShaderProgram ();
};
...
private:
	...
	InputSamplerBindings	samplerBindings;		// bindings for samplers
...
public:
	...
	void SetSamplerBinding (const char* samplername, uint32_t binding) override;
