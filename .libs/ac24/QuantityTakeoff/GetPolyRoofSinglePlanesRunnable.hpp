...
private:
	...
	virtual void Run () override
	{
		...
		try {
			...
			ce.NewElem ();
			ce.MergeBody (attReader, currBody, perBodyElem->GetConstTrafo (),
			...
			CDOperationGroups (component, nullptr, CG_INTERSECT, 0, baseGroupId, toolGroupId, GS::NULLGuid, &resultGroupId, 0 /*cutLineColor*/, 0 /*cutSurfaceGlima*/, 0 /*cutSurfaceGlimaColor*/,
								Modeler::PolygonId (PolyRoofEdgeBetweenPlanesSurfaceType), Modeler::ForceToolIds, Modeler::OGDefault, GS::NoValue);
