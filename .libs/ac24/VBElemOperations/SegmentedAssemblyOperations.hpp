...
VB_ELEM_OPERATIONS_DLL_EXPORT GS::Variant<Sector3D, Geometry::EllipseArc3D> GetReferenceLineGeometry (const VBElem::SegmentedAssemblyConstRef& segmentedAssembly);
// --- End Predeclarations
